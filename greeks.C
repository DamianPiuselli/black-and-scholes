...
int main(int argc, char **argv)
{
    ...
    double c_delta = call_delta(S, K, r, v, T);
    double p_delta = put_delta(S, K, r, v, T);

    printf("Call delta: %.2f\n", c_delta);
    printf("Put delta: %.2f\n", p_delta);
